...
(function($) {
 ...
 /**
   ...
   */
  $.facebox.settings = {
    loading_image : '/facebox/v2/loading.gif',
    close_image   : '/facebox/v2/closelabel.gif',
    image_types   : [ 'png', 'jpg', 'jpeg', 'gif' ],
    next_image    : '/facebox/v2/next.gif',
    prev_image    : '/facebox/v2/prev.gif',
    play_image    : '/facebox/v2/play.gif',
    pause_image   : '/facebox/v2/pause.gif',
    slide_duration: 6,
    facebox_html  : '\
          ...
          <tr> \
            ...
            <td class="body"> \
              ...
              <div class="footer"> \
                ...
                <a href="#" class="close"> \
                  <img src="/facebox/v2/loading.gif" title="close" class="close_image" /> \
                </a> \
